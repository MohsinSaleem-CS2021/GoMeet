...
public class LocationAddressIntent extends IntentService {

    private ResultReceiver resultReceiver;
    public LocationAddressIntent() {
        super("LocationAddressIntent");
    }
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        if (intent != null){
            ...
            List <Address> serviceAddress = null;
            try{
                serviceAddress = geocoder.getFromLocation(location.getLatitude() , location.getLongitude(), 1);
            }
            catch (Exception e){
            ...
            if(serviceAddress == null || serviceAddress.isEmpty()){
                ...
                Address address = serviceAddress.get(0);
